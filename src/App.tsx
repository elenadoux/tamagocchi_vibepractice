import {Customization,useCustomization} from './components/Customization';
...
export default function App(){
 useWebMCP();
 const {skin,update}=useCustomization();
 ...
 return <main><header className="masthead"><span className="wordmark">tama<span className="wordmark-dot">•</span></span><span className="edition">POCKET MUSIC COMPANION<br/>MODEL 001 · {skin.name.toUpperCase()}</span></header><Customization skin={skin} update={update}/><DeviceBoundary><TamagotchiDevice skin={skin} onWake={ui.wake} buttons={[
